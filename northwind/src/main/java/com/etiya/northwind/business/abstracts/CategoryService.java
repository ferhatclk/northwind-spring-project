...
public interface CategoryService {
	...
	DataResult<List<CategoryListResponse>> getAllByPageNumber(int pageNo, int pageSize);
	DataResult<List<CategoryListResponse>> getAllSortedByDesc(String field);
	DataResult<List<CategoryListResponse>> getAllSortedByAsc(String field);
