...
public class CustomersController {
    ...
    public DataResult<List<CustomerListResponse>> getByPageNumber(@RequestParam int pageNo, int pageSize){
    	return this.customerService.getAllByPageNumber(pageNo, pageSize);
    }
    
    @GetMapping("/getallsortedbydesc")
	public DataResult<List<CustomerListResponse>> getAllSortedByDesc(@RequestParam String field){
		return this.customerService.getAllSortedByDesc(field);
	}
	
	@GetMapping("/getallsortedbyasc")
	public DataResult<List<CustomerListResponse>> getAllSortedByAsc(@RequestParam String field){
